        ...
        private void OnGUI()
        {
...
#endif
            DrawRequirement("Unity 2019.4 or Newer", validUnityVersion);
            ...
            if (!string.IsNullOrEmpty(locomotionLocation) && File.Exists(locomotionLocation)) {
                ...
                if (assetInfoType != null) {
                    ...
                    if (versionProperty != null) {
                        ...
                        if (version.CompareTo(new Version("2.3")) < 0) {
            ...
            if (requireCleanInstall) {
                ...
                if (priorVersionInstalled) {
                    EditorGUILayout.HelpBox("Version 2.3 contains major structural changes. Before importing remove the Opsive/UltimateCharacterController and Opsive/Shared folders. " +
            ...
            GUILayout.Space(5);
            GUI.enabled = validUnityVersion && validInstallPackage && !priorVersionInstalled;
