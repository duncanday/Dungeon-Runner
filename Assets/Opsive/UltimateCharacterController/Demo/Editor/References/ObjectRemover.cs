    ...
    public class ObjectRemover
    {
        ...
        private static void ProcessObjectReferences(ObjectReferences objectReferences, bool fromScene)
        {
            ...
            if (cameraController != null) {
                ...
                Shared.Editor.Utility.EditorUtility.SetDirty(cameraController);
            }
            ...
            if (characterLocomotion != null) {
...
#else
                characterLocomotion.SetMovementType(Shared.Utility.TypeUtility.GetType(characterLocomotion.ThirdPersonMovementTypeFullName));
#endif
                ...
                if (animator != null && animator.runtimeAnimatorController == null) {
                    ...
                    Shared.Editor.Utility.EditorUtility.SetDirty(animator);
                }
                ...
                if (itemSetManager != null) {
                    ...
                    Shared.Editor.Utility.EditorUtility.SetDirty(itemSetManager);
                }
            }
        ...
        private static void CheckItem(GameObject gameObject)
        {
            ...
            for (int i = 0; i < magicItems.Length; ++i) {
                ...
                Shared.Editor.Utility.EditorUtility.SetDirty(magicItems[i]);
            }
        }
#endif
        ...
        private static void LockDoors(GameObject[] doors)
        {
            ...
            for (int i = 0; i < doors.Length; ++i) {
                ...
                Shared.Editor.Utility.EditorUtility.SetDirty(door);
            }
        }
#endif
    }
