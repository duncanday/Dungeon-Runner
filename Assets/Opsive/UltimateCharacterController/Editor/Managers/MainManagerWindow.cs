...
namespace Opsive.UltimateCharacterController.Editor.Managers
{
    ...
    public class MainManagerWindow : EditorWindow
    {
        ...
        private const string c_ProjectStatusGUID = "7e37b1ab2412bb149ab5b158ea8e9898";
        ...
        private static void EditorStartup()
        {
            ...
            var projectStatusPath = AssetDatabase.GUIDToAssetPath(c_ProjectStatusGUID);
            if (string.IsNullOrEmpty(projectStatusPath)) {
                return;
            }

            var importStatus = AssetDatabase.LoadAssetAtPath<ImportStatus>(projectStatusPath);
